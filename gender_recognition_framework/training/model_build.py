...
def senet_model_build(input_shape=(224, 224, 3), num_classes=100, weights="imagenet"):
...
def mobilenet_224_build(input_shape=(224, 224, 3), num_classes=100, weights="imagenet"):
...
def vgg16_keras_build(input_shape=(224, 224, 3), num_classes=100, weights="imagenet"):
    # Alpha version
...
def densenet_121_build(input_shape=(224, 224, 3), num_classes=100, weights="imagenet", lpf_size=1):
...
def mobilenet_64_build(input_shape=(64, 64, 3), num_classes=100):
...
def mobilenet_96_build(input_shape=(96,96,3), num_classes=100, weights="imagenet"):
...
def xception_build(input_shape=(299,299,3), num_classes=100, weights="imagenet", lpf_size=1):
...
def squeezenet_build(input_shape=(224, 224, 3), num_classes=100, weights="imagenet"):
...
def shufflenet_224_build(input_shape=(224, 224, 100), num_classes=100, weights="imagenet"):
...
def vggface_custom_build(input_shape, num_classes=100, weights="vggface2", net="vgg16", lpf_size=1):
    sys.path.append('keras_vggface')
